# Proposal: package Nara Lossless Editor as a standalone macOS .app
...
4. Apple Silicon build: `python3 setup.py py2app` (arm64 interpreter) → `dist/Nara Lossless Editor.app`; move aside to `dist-arm64/`.
