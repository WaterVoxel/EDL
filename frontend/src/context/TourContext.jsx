...
export const TOUR_STEPS = [
  ...
  { id: 'editToolbar', text: 'The edit toolbar acts on the selected clip: Hold (freeze a frame), Trim, Duplicate, Reverse, Split (splice at the playhead), Raise (round duration up), and Speed (slow motion).' },
