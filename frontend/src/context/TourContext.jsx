...
export const TOUR_STEPS = [
  ...
  { id: 'reformat', text: 'Reformat — chosen from the Mode menu in the top bar — is a one-shot resize of the clip selected in the Media Bin: pick a resolution tier and aspect ratio and it scales down to fit (contain-fit, never upscales), writing a brand-new file — the source is never touched. It works outside the timeline, so no clips required.' },
  { id: 'agentDock', text: 'The AGENT mode lets you chat with a local Claude CLI to propose an ffmpeg edit, which you approve before it runs. The Actions mode shows a log of warnings and pending-render notices — Timeline/AGENT/Reformat/Actions share this one dock, one at a time, and the Mode menu at the top left is how you switch between them.' },
